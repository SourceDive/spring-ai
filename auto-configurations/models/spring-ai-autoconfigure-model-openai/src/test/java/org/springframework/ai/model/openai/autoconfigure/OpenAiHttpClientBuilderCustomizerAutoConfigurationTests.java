...
/**
 * Verifies that {@link OpenAiHttpClientBuilderCustomizer} beans declared in the
 * application context are picked up by each OpenAI model auto-configuration.
 */
class OpenAiHttpClientBuilderCustomizerAutoConfigurationTests {

	private static final String COMMON_PROPS = "spring.ai.openai.api-key=test-key";
